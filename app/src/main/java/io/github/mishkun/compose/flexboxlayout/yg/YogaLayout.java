...
package io.github.mishkun.compose.flexboxlayout.yg;
...
import io.github.mishkun.compose.flexboxlayout.R;
...
public class YogaLayout extends ViewGroup {
   ...
   *
   * If the child is a {@link com.facebook.yoga.android.VirtualYogaLayout}, we also use its Yoga node, but we also instruct it
   * to transfer all of its children to this {@link YogaLayout} while preserving the Yoga tree (so
   * that the layout of its children is correct).  The {@link com.facebook.yoga.android.VirtualYogaLayout} is then not added
